pub const Config = struct {
    grid_width: u32 = 512,
    grid_height: u32 = 512,
    starting_organisms: u32 = 40000,
    max_population: u32 = 300000,
    starting_energy: u32 = 500,
    starting_resources: u16 = 40,
    ...
    mutualism_low: u8 = 30,
    parasitism_steal_pct: u8 = 50,
    mutualism_bonus: u16 = 15,
    point_mutation_rate: u16 = 50,
    region_duplication_rate: u16 = 80,
    region_shrink_rate: u16 = 20,
    insertion_rate: u16 = 30,
    deletion_rate: u16 = 30,
    diffusion_denom: u8 = 8,
    injection_amount: u16 = 2,
    injection_interval: u16 = 10,
    age_death_base: u16 = 20,
    age_death_byte_denom: u16 = 2,
